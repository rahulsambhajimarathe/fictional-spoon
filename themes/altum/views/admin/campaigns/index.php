...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 mb-3 mb-md-0"><i class="fas fa-fw fa-xs fa-server text-primary-900 mr-2"></i> <?= l('admin_campaigns.header') ?></h1>
                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="order_by" id="filters_order_by" class="custom-select custom-select-sm">
                                ...
                                <option value="domain" <?= $data->filters->order_by == 'domain' ? 'selected="selected"' : null ?>><?= l('campaigns.input.domain') ?></option>
                            </select>
                        </div>
                ...
                <td class="text-nowrap">
                    <div class="d-flex flex-column">
                        ...
                        <div class="text-muted">
                            <img src="<?= get_favicon_url_from_domain($row->domain) ?>" class="img-fluid icon-favicon mr-1" loading="lazy" />
                            <?= $row->domain ?>
                        </div>
                    </div>
                </td>
                ...
                <td class="text-nowrap">
                    <div class="d-flex align-items-center">
                        <a href="<?= url('admin/notifications?campaign_id=' . $row->campaign_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('admin_notifications.menu') ?>">
                            <i class="fas fa-fw fa-bell text-muted"></i>
                        </a>
                    </div>
                </td>
