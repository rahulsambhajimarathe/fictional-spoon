                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="d-flex flex-column flex-lg-row">
                                <div class="pr-lg-3">
                                    ...
                                    <a class="dropdown-item <?= in_array(\Altum\Router::$controller, ['Campaigns', 'Campaign']) ? 'active' : null ?>" href="<?= url('campaigns') ?>"><i class="fas fa-fw fa-sm fa-server mr-2"></i> <?= l('campaigns.menu') ?></a>
                                </div>
