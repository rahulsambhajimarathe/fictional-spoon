<?php if(\Altum\Authentication::check() && isset($_SESSION['admin_user_id'])): ?>
    <div class="w-100 py-2 bg-gray-100 border-bottom small text-muted">
        <div class="container d-flex justify-content-between">
            ...
            <div><a href="<?= url('logout?admin_impersonate_user') ?>" class="text-dark text-decoration-none"><i class="fas fa-fw fa-sm fa-times mr-1"></i> <?= l('global.admin_impersonate_user_logout') ?></a></div>
        </div>
    </div>
<?php endif ?>
