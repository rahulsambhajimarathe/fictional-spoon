...
<div class="modal fade" id="custom_branding_campaign_modal" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="d-flex justify-content-between mb-3">
                    <h5 class="modal-title">
                        ...
                        <?= l('custom_branding_campaign_modal.header') ?>
                    </h5>
                ...
                <form name="custom_branding_campaign" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="custom_branding_name"><i class="fas fa-fw fa-sm fa-signature text-muted mr-1"></i> <?= l('custom_branding_campaign_modal.input.name') ?></label>
                    ...
                    <div class="form-group">
                        <label for="custom_branding_url"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('custom_branding_campaign_modal.input.url') ?></label>
